...
import io.costax.demo.domain.exceptions.BusinessException;
...
import io.costax.demo.domain.exceptions.UserWithSameEmailAlreadyExistsException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleAccessDeniedException(org.springframework.security.access.AccessDeniedException ex, WebRequest request) {
        ...
        String detail = "You do not have permission to perform this operation.";
    ...
    protected ResponseEntity<Object> handleBindException(BindException ex,
                                                         ...
                                                         HttpStatus status,
                                                         WebRequest request) {
        return this.customValidationExceptionInternalHandler(ex, ex.getBindingResult(), headers, status, request);
    }
