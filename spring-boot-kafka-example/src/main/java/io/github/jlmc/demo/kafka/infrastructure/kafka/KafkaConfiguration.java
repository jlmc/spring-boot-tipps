...
public class KafkaConfiguration {
    ...
    public ConsumerFactory<String, OrderBookedEvent> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(OrderBookedEvent.class));
    }
    ...
    public ConcurrentKafkaListenerContainerFactory<String, OrderBookedEvent> bookListener() {
        ConcurrentKafkaListenerContainerFactory<String, OrderBookedEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
