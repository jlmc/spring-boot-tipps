...
//@AutoConfigureTestDatabase(connection = EmbeddedDatabaseConnection.DERBY) // derby do not have sequences
public class TaskRespositoryUsingOtherEmbeddableDbsIT {
